...
$pdf->AddPage(); 
   ...
   // $pdf->Line(10,80,200,80);
    ...
    $pdf->Cell(25,7,utf8_decode("Mês pago"),0,0,'C',1); 
  ...
  $pdf->Cell(50,7,utf8_decode($lista->name),1,0,'C');
     ...
     $pdf->Cell(20,7,"Pronto",1,0,'C'); 
      ...
      $pdf->SetFillColor(255,255,255);  
        ...
        $pdf->Cell(165,9,utf8_decode('Descrição de Serviços'),1,0,'C',1);
 ...
 $pdf->Ln(5); 
        ...
        $pdf->SetFont('Times','I',10);
          $pdf->Cell(110,3,'Documento processado por Computador / @BIS Software',0,0,'L',1);
           $pdf->SetFont('Times','',10);
          $pdf->Cell(60,3,utf8_decode('Valor de prestação: '),0,0,'R',1);
          ...
          $pdf->Ln(5); 
            ...
            $pdf->Cell(50,3,utf8_decode('Motivo de Isenção'),0,0,'L',1);
            $pdf->SetFont('Times','',11);
            $pdf->Cell(35,3,utf8_decode('Valor de prestação: '),0,0,'L',1);
            $pdf->Cell(20,3,escape($lista->valor_prestacao),0,0,'L',1);
            $pdf->Ln(3);
              $pdf->SetFont('Times','',10);
