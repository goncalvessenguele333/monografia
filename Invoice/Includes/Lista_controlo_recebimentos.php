...
<ul class="navbar-nav">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Listagem de controlo de recebimentos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Principal.php">Home</a></li>
              <li class="breadcrumb-item active">Listagem de controlo de recebimentos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
