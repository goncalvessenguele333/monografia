...
$('#add_product_venda').click(function(e){
      ...
      var cod_servico=$('#txt_cod_producto').val();
...
function gerarPDF(cliente,factura){
  ...
  function searchForDetalhe(id){
    var action='searchForDetalhe_cotacao';
    var user=id;
    $.ajax({
      url:'../classes/ajax.php',
      type:"POST",
...
function viewProcessar(){
  ...
  function del_produt_detalhe(correlativo){
    var action='apagaProductDetalhe_cotacao';
...
<ul class="navbar-nav">
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa-cube"></i>Cotação</h1>
          </div>
          <div class="col-sm-6">
  ...
  <thead>
    ...
    <tr> 
      ...
      <td><input type="text" id="txt_preco" class="form-control" name="txt_preco" placeholder="0.00"></td>
          <td><input type="text" id="txt_desconto" value="0" class="form-control" name="txt_desconto" placeholder="Desconto em %"></td>
