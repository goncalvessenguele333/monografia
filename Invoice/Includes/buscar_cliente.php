...
if(isset($_REQUEST['buscarcliente']) && $_REQUEST['buscarcliente']== ''){
  Redirect::to('Lista_Cliente.php');
}

if(!empty($_REQUEST['buscarcliente'])){
$buscarCliente=strtolower($_REQUEST['buscarcliente']);
$where="idCliente=$buscarCliente";
}
...
$query= mysqli_query($conexao,"SELECT * FROM tb_cliente WHERE $where");
